<?php
/**
 * JQuarks4s Component surveys View
 *
 * @version     $Id$
...
class JQuarks4sViewSurveys extends JView
{
    function display($tpl = null)
    {
        $surveys =& $this->get( 'SurveysWithSections' );

        $this->assignRef( 'surveys', $surveys );

        // TOOLBAR
  	Jquarks4sToolBarHelper::title( JText::_( 'SURVEYS' ), 'survey.png' );
	...
	JToolBarHelper::addNewX();
        ...
        JSubMenuHelper::addEntry( JText::_( 'SURVEYS' ),        'index.php?option=com_jquarks4s&controller=surveys', true);
