<?php
/**
 * JQuarks4s Component sessions View
 *
 * @version     $Id$
...
class JQuarks4sViewSessions extends JView
{
    function display($tpl = null)
    {
        ...
        // TOOLBAR
  		Jquarks4sToolBarHelper::title( JText::_( 'ANSWERS' ), 'session.png' );
        ...
        JSubMenuHelper::addEntry( JText::_( 'ANSWERS' ),       'index.php?option=com_jquarks4s&controller=sessions', true);
